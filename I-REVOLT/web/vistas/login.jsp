...
<html>
    ...
    <link href="../otros/register.css" rel="stylesheet" type="text/css"/>
<body>
    <!--================ Menu Area Inicio=================-->
    ...
    <!--================Login Box Area =================-->
        <!--================ Login Box Area =================-->
        <section class="login-max">
            <div class="container-l" id="container-l">
                <div class="form-container-l sign-up">
             
                        <form action="${pageContext.request.contextPath}/ClienteServlet" method="POST" onsubmit="return validarContrasena()">
                        <h1>Crear cuenta</h1>
        ...
        <!-- Colocado fuera del contenedor del formulario -->
        <div id="passwordRequirements" class="password-popup">
        ...
        <!--================ Password Requirements Popup Fin =================-->
    <!--================End Login Box Area =================-->
