...
[x] Infraestructura de Servidor: Instalación y vinculación de Apache Tomcat 10 para el despliegue local, asegurando que el servidor reconozca la estructura de la aplicación.

[x] Reorganización de Recursos Web: Reubicación manual de la carpeta web y el directorio WEB-INF en las propiedades del proyecto para solucionar el error de "Build Failed".
...
- [x] Accesibilidad ARIA: Implementación de atributos aria-label en botones de búsqueda, carrito y redes sociales para compatibilidad con lectores de pantalla.

- [x] Refactorización Semántica: Migración de etiquetas genéricas a elementos HTML5 (, , ) y adopción de sistema de tarjetas responsivas.
